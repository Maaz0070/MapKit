...
class PickerDialog: UIView, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func show(title: String, doneButtonTitle: String = "Done", cancelButtonTitle: String = "Cancel", options: [String], selected: Int = 0, callback: @escaping PickerCallback) {
    ...
    @objc func buttonTapped(sender: UIButton!) {
        if sender.tag == kPickerDialogDoneButtonTag {
            ...
            if self.pickerData.count != 0{
                ...
                self.callback?(selectedValue, selectedIndex)
            }
        }
